...
class purpleplay_lite_breadcrumb_class {
    ...
    function custom_breadcrumb() {
        ...
        echo '<section class="cont_nav"><div class="cont_nav_inner"><p><a href="' . esc_url( home_url('/') ) . '/">' . __('Home', 'purpleplay-lite') . '</a>';
    ...
    function simple_breadcrumb_case($der_post) {
        ...
        if (is_author()) {
           ...
           global $wp_query;
            ...
            return __('Author', 'purpleplay-lite') . ': ' . $curauth->display_name;
        ...
        if (is_tag()) {
            ...
            return __('Tag', 'purpleplay-lite') . ': ' . single_tag_title('', false);
        ...
        if (is_search()) {
            ...
            return __('Search', 'purpleplay-lite');

        }

		if (is_404()) {

            return __('Error 404', 'purpleplay-lite');
...
$skt_breadcumb = new purpleplay_lite_breadcrumb_class();